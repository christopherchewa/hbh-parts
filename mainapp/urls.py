...
urlpatterns = [
    ...
    path('delete-property/<int:id>/', views.delete_property, name="delete-property"),#new url
    ...
    path('close-request/<int:id>/', views.close_request, name="close-request"),
    ...
    path('all-properties-inside/<int:id>/', views.all_properties_inside, name="all-properties-inside"),
    path('account/', views.account, name="account"),
