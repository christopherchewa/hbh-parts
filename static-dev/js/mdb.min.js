...
! function (e, t) {
    ...
    var T = function (e) {
        ...
        for (t in n = oe.support = {}, o = oe.isXML = function (e) {
                ...
                return a !== h && 9 === a.nodeType && a.documentElement ? (p = (h = a).documentElement, g = !o(h), _ !== h && (r = h.defaultView) && r.top !== r && (r.addEventListener ? r.addEventListener("unload", ie, !1) : r.attachEvent && r.attachEvent("onunload", ie)), n.attributes = le(function (e) {
                    ...
                    return i || (1 & (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === i ? e === h || e.ownerDocument === _ && b(_, e) ? -1 : t === h || t.ownerDocument === _ && b(_, t) ? 1 : u ? I(u, e) - I(u, t) : 0 : 4 & i ? -1 : 1)
                } : function (e, t) {
                    if (e === t) return d = !0, 0;
                    var n, i = 0,
                        r = e.parentNode,
                ...
                if ((e.ownerDocument || e) !== h && f(e), t = t.replace(V, "='$1']"), n.matchesSelector && g && !k[t + " "] && (!v || !v.test(t)) && (!m || !m.test(t))) try {
                    var i = y.call(e, t);
            ...
            return i && !i[w] && (i = _e(i)), r && !r[w] && (r = _e(r, o)), se(function (o, a, s, l) {
                ...
                if (o) {
                    if (r || e) {
                        ...
                        for (u = v.length; u--;)(d = v[u]) && (c = r ? I(o, d) : f[u]) > -1 && (o[c] = !(a[c] = d))
                    }
            ...
            var n = t.length > 0,
                ...
                o = function (o, a, s, l, u) {
                    var d, p, m, v = 0,
                        ...
                        S = T.length;
                    for (u && (c = a === h || a || u); y !== S && null != (d = T[y]); y++) {
                        if (r && d) {
        ...
        return me.prototype = i.filters = i.pseudos, i.setFilters = new me, a = oe.tokenize = function (e, t) {
            ...
            for (s = e, l = [], c = i.preFilter; s;) {
                for (a in n && !(r = B.exec(s)) || (r && (s = s.slice(r[0].length) || s), l.push(o = [])), n = !1, (r = F.exec(s)) && (n = r.shift(), o.push({
                        value: n,
                        type: r[0].replace(q, " ")
    ...
    w.fn.extend({
        ...
        w.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = w.filter(i, r)), this.length > 1 && (L[e] || w.uniqueSort(r), N.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var j = /[^\x20\t\r\n\f]+/g;
                ...
                r = {
                    ...
                    then: function (t, i, r) {
                                ...
                                var s = this,
                                    ...
                                    c = function () {
                                        ...
                                        if (!(t < o)) {
                                            ...
                                            c = e && ("object" == typeof e || "function" == typeof e) && e.then, g(c) ? r ? c.call(e, a(o, n, $, r), a(o, n, M, r)) : (o++, c.call(e, a(o, n, $, r), a(o, n, M, r), a(o, n, $, n.notifyWith))) : (i !== $ && (s = void 0, l = [e]), (r || n.resolveWith)(s, l))
                                        }
                                    },
                                    u = r ? c : function () {
                                        try {
                                            ...
                                            w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, u.stackTrace), t + 1 >= o && (i !== M && (s = void 0, l = [e]), n.rejectWith(s, l))
                                        }
                                    };
                        ...
                        return w.Deferred(function (e) {
                            n[0][3].add(a(0, e, g(r) ? r : $, e.notifyWith)), n[1][3].add(a(0, e, g(t) ? t : $)), n[2][3].add(a(0, e, g(i) ? i : M))
                        }).promise()
                    },
                    promise: function (e) {
    ...
    function Ie(e, t, n, i) {
        ...
        var r, o, s, l, c, u, d = 0,
            ...
            m = t[0],
            v = g(m);
        if (v || f > 1 && "string" == typeof m && !p.checkClone && Ee.test(m)) return e.each(function (r) {
            var o = e.eq(r);
            v && (t[0] = m.call(this, r, o.html())), Ie(o, t, n, i)
        });
        if (f && (o = (r = me(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
            for (l = (s = w.map(he(r, "script"), Ae)).length; d < f; d++) c = r, d !== h && (c = w.clone(c, !0, !0), l && w.merge(s, he(c, "script"))), n.call(e[d], c, d);
            if (l)
    ...
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                for (a = he(s), i = 0, r = (o = he(e)).length; i < r; i++) Le(o[i], a[i]);
            if (t)
                if (n)
                    for (o = o || he(e), a = a || he(s), i = 0, r = o.length; i < r; i++) Ne(o[i], a[i]);
                else Ne(e, s);
    ...
    function We(e, t, n) {
        ...
        return (n = n || Me(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || w.contains(e.ownerDocument, e) || (a = w.style(e, t)), !p.pixelBoxStyles() && $e.test(a) && He.test(t) && (i = s.width, r = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = r, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    w.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, a, s = Y(t),
                    l = Be.test(t),
                    c = e.style;
                if (l || (t = ze(s)), a = w.cssHooks[t] || w.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r : c[t];
        ...
        css: function (e, t, n, i) {
            var r, o, a, s = Y(t);
            return Be.test(t) || (t = ze(s)), (a = w.cssHooks[t] || w.cssHooks[s]) && "get" in a && (r = a.get(e, !0, n)), void 0 === r && (r = We(e, t, i)), "normal" === r && t in Ve && (r = Ve[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), w.each(["height", "width"], function (e, t) {
        w.cssHooks[t] = {
            get: function (e, n, i) {
                if (n) return !qe.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ge(e, t, i) : re(e, Fe, function () {
                    return Ge(e, t, i)
                })
            },
            set: function (e, n, i) {
                var r, o = Me(e),
                    ...
                    s = i && Qe(e, t, i, a, o);
                return a && p.scrollboxSize() === o.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Qe(e, t, "border", !1, o) - .5)), s && (r = te.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = w.css(e, t)), Ue(0, n, s)
            }
        }
        ...
        css: function (e, t) {
            return B(this, function (e, t, n) {
                var i, r, o = {},
                    a = 0;
                if (Array.isArray(t)) {
                    for (i = Me(e), r = t.length; a < r; a++) o[t[a]] = w.css(e, t[a], !1, i);
                    return o
                }
    ...
    w.extend(w.event, {
        trigger: function (t, n, r, o) {
            ...
            if (s = p = l = r = r || i, 3 !== r.nodeType && 8 !== r.nodeType && !gt.test(y + w.event.triggered) && (y.indexOf(".") > -1 && (y = (b = y.split(".")).shift(), b.sort()), u = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), h = w.event.special[y] || {}, o || !h.trigger || !1 !== h.trigger.apply(r, n))) {
                ...
                for (a = 0;
                    (s = v[a++]) && !t.isPropagationStopped();) p = s, t.type = a > 1 ? c : h.bindType || y, (f = (Q.get(s, "events") || {})[t.type] && Q.get(s, "handle")) && f.apply(s, n), (f = u && s[u]) && f.apply && z(s) && (t.result = f.apply(s, n), !1 === t.result && t.preventDefault());
    ...
    It.href = vt.href, w.extend({
        ...
        ajax: function (t, n) {
            ...
            if (v.promise(C), p.url = ((t || p.url || vt.href) + "").replace(At, vt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(j) || [""], null == p.crossDomain) {
                c = i.createElement("a");
                try {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = w.param(p.data, p.traditional)), $t(Dt, p, n, C), u) return C;
            ...
            if (T = "abort", y.add(p.complete), C.done(p.success), C.fail(p.error), r = $t(Nt, p, n, C)) {
    ...
    w.ajaxSetup({
        ...
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (p.createHTMLDocument ? ((r = (t = i.implementation.createHTMLDocument("")).createElement("base")).href = i.location.href, t.head.appendChild(r)) : t = i), a = !n && [], (o = O.exec(e)) ? [t.createElement(o[1])] : (o = me([e], t, a), a && a.length && w(a).remove(), w.merge([], o.childNodes)));
        var r, o, a
        ...
        w.cssHooks[t] = Re(p.pixelPosition, function (e, n) {
            if (n) return n = We(e, t), $e.test(n) ? w(e).position()[t] + "px" : n
        })
    }), w.each({
        Height: "height",
        Width: "width"
    ...
    return w.noConflict = function (t) {
        return e.$ === w && (e.$ = Ft), t && e.jQuery === w && (e.jQuery = Bt), w
    }, t || (e.jQuery = e.$ = w), w
}),
function (e, t) {
    ...
    function d(e, t, n, i) {
        return M(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], r(10) ? parseInt(n["offset" + e]) + parseInt(i["margin" + ("Height" === e ? "Top" : "Left")]) + parseInt(i["margin" + ("Height" === e ? "Bottom" : "Right")]) : 0)
    }
    ...
    function g(e, n) {
        ...
        o && s && (u.top = M(u.top, 0), u.left = M(u.left, 0));
        var v = h({
            top: l.top - u.top - g,
    ...
    function m(e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
            ...
            i = g(e, n),
            r = M(n.clientWidth, window.innerWidth || 0),
            o = M(n.clientHeight, window.innerHeight || 0),
            a = t ? 0 : l(n),
            s = t ? 0 : l(n, "left");
        return h({
    ...
    for (var I = Math.min, j = Math.round, $ = Math.floor, M = Math.max, H = "undefined" != typeof window && "undefined" != typeof document, W = ["Edge", "Trident", "Firefox"], R = 0, q = 0; q < W.length; q += 1)
        if (H && 0 <= navigator.userAgent.indexOf(W[q])) {
            R = 1;
            break
        } var B = H && window.Promise ? function (e) {
            var t = !1;
            return function () {
        ...
        F = H && !(!window.MSInputMethodContext || !document.documentMode),
        V = H && /MSIE 10/.test(navigator.userAgent),
        X = function (e, t) {
        ...
        K = function () {
            function t(n, i) {
                ...
                }, this.update = B(this.update.bind(this)), this.options = U({}, t.Defaults, o), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = n && n.jquery ? n[0] : n, this.popper = i && i.jquery ? i[0] : i, this.options.modifiers = {}, Object.keys(U({}, t.Defaults.modifiers, o.modifiers)).forEach(function (e) {
                    r.options.modifiers[e] = U({}, t.Defaults.modifiers[e] || {}, o.modifiers ? o.modifiers[e] : {})
                ...
                value: function () {
                    return function () {
                        if (!this.state.isDestroyed) {
                            ...
                            e.offsets.reference = _(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = w(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = C(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = k(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                        }
                    }.call(this)
                }
            }, {
    ...
    return K.Utils = ("undefined" == typeof window ? global : window).PopperUtils, K.placements = Q, K.Defaults = {
        placement: "bottom",
        positionFixed: !1,
        eventsEnabled: !0,
        removeOnDestroy: !1,
        ...
        modifiers: {
                ...
                fn: function (e, t) {
                    ...
                    var u = t.priority,
                        ...
                        f = {
                            primary: function (e) {
                                var n = d[e];
                                return d[e] < c[e] && !t.escapeWithReference && (n = M(d[e], c[e])), z({}, e, n)
                            },
                            secondary: function (e) {
                                var n = "right" === e ? "left" : "top",
                                    i = d[n];
                                return d[e] > c[e] && !t.escapeWithReference && (i = I(d[n], c[e] - ("right" === e ? d.width : d.height))), z({}, n, i)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function (e, n) {
                    ...
                    return _ = M(I(s[u] - m, _), 0), e.arrowElement = r, e.offsets.arrow = (z(i = {}, f, j(_)), z(i, p, ""), i), e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function (e, t) {
                    ...
                    return a.forEach(function (s, l) {
                        ...
                        (f || v || b) && (e.flipped = !0, (f || v) && (i = a[l + 1]), b && (o = "end" === o ? "start" : "start" === o ? "end" : o), e.placement = i + (o ? "-" + o : ""), e.offsets.popper = U({}, e.offsets.popper, C(e.instance.popper, e.offsets.reference, e.placement)), e = k(e.instance.modifiers, e, "flip"))
                    }), e
                },
                behavior: "flip",
                padding: 5,
            ...
            computeStyle: {
                ...
                fn: function (e, t) {
                    ...
                    return e.attributes = U({}, w, e.attributes), e.styles = U({}, f, e.styles), e.arrowStyles = U({}, e.offsets.arrow, e.arrowStyles), e
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
...
function (e, t) {
    ...
    t(document).on(f, '[data-dismiss="alert"]', h._handleDismiss(new h)), t.fn.alert = h._jQueryInterface, t.fn.alert.Constructor = h, t.fn.alert.noConflict = function () {
        return t.fn.alert = c, h._jQueryInterface
    };
    var p = t.fn.button,
        g = "active",
        ...
        b = "focus.bs.button.data-api blur.bs.button.data-api",
        w = function () {
            function e(e) {
                this._element = e
            }
            ...
            return n.toggle = function () {
                ...
                if (i) {
                    ...
                    if (r) {
                        if ("radio" === r.type)
                            if (r.checked && this._element.classList.contains(g)) e = !1;
                            else {
                                var o = i.querySelector(".active");
                                o && t(o).removeClass(g)
                            } if (e) {
                            if (r.hasAttribute("disabled") || i.hasAttribute("disabled") || r.classList.contains("disabled") || i.classList.contains("disabled")) return;
                            r.checked = !this._element.classList.contains(g), t(r).trigger("change")
                        }
                        r.focus(), n = !1
                    }
                }
                n && this._element.setAttribute("aria-pressed", !this._element.classList.contains(g)), e && t(this._element).toggleClass(g)
            }, n.dispose = function () {
    ...
    t(document).on(y, m, function (e) {
        e.preventDefault();
        var n = e.target;
        t(n).hasClass("btn") || (n = t(n).closest(v)), w._jQueryInterface.call(t(n), "toggle")
    }).on(b, m, function (e) {
        var n = t(e.target).closest(v)[0];
        t(n).toggleClass("focus", /^focus(in)?$/.test(e.type))
    }), t.fn.button = w._jQueryInterface, t.fn.button.Constructor = w, t.fn.button.noConflict = function () {
        return t.fn.button = p, w._jQueryInterface
    };
    var _ = "carousel",
        x = t.fn[_],
        T = {
        ...
        A = "mouseenter.bs.carousel",
        D = "mouseleave.bs.carousel",
        N = "touchstart.bs.carousel",
        L = "touchmove.bs.carousel",
        I = "touchend.bs.carousel",
        j = "pointerdown.bs.carousel",
        $ = "pointerup.bs.carousel",
        M = "dragstart.bs.carousel",
        H = "load.bs.carousel.data-api",
        W = "click.bs.carousel.data-api",
        R = "active",
        q = {
            ACTIVE: ".active",
        ...
        F = function () {
            ...
            return n.next = function () {
                ...
                e || (this._isPaused = !0), this._element.querySelector(q.NEXT_PREV) && (l.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, n.cycle = function (e) {
                ...
                if (!(e > this._items.length - 1 || e < 0))
                    if (this._isSliding) t(this._element).one(O, function () {
                        return n.to(e)
                    });
                    else {
                ...
                return e = a({}, T, e), l.typeCheckConfig(_, e, C), e
                ...
                var e = this;
                this._config.keyboard && t(this._element).on(P, function (t) {
                    return e._keydown(t)
                }), "hover" === this._config.pause && t(this._element).on(A, function (t) {
                    return e.pause(t)
                }).on(D, function (t) {
                    return e.cycle(t)
                ...
                if (this._touchSupported) {
                    ...
                    t(this._element.querySelectorAll(q.ITEM_IMG)).on(M, function (e) {
                        return e.preventDefault()
                    }), this._pointerEvent ? (t(this._element).on(j, function (e) {
                        return n(e)
                    }), t(this._element).on($, function (e) {
                        return i(e)
                    }), this._element.classList.add("pointer-event")) : (t(this._element).on(N, function (e) {
                        return n(e)
                    }), t(this._element).on(L, function (t) {
                        return function (t) {
                            t.originalEvent.touches && t.originalEvent.touches.length > 1 ? e.touchDeltaX = 0 : e.touchDeltaX = t.originalEvent.touches[0].clientX - e.touchStartX
                        }(t)
                    }), t(this._element).on(I, function (e) {
                        return i(e)
                    }))
                }
                ...
                var a = (r + (e === k ? -1 : 1)) % this._items.length;
                return -1 === a ? this._items[this._items.length - 1] : this._items[a]
            }, n._triggerSlideEvent = function (e, n) {
                var i = this._getItemIndex(e),
                    r = this._getItemIndex(this._element.querySelector(q.ACTIVE_ITEM)),
                    o = t.Event(E, {
                        relatedTarget: e,
                        direction: n,
                        from: r,
                ...
                if (e === S ? (i = "carousel-item-left", r = "carousel-item-next", o = "left") : (i = "carousel-item-right", r = "carousel-item-prev", o = "right"), u && t(u).hasClass(R)) this._isSliding = !1;
                    ...
                    if (t(this._element).hasClass("slide")) {
                        ...
                        t(s).one(l.TRANSITION_END, function () {
                            t(u).removeClass(i + " " + r).addClass(R), t(s).removeClass(R + " " + r + " " + i), a._isSliding = !1, setTimeout(function () {
                                return t(a._element).trigger(h)
                            }, 0)
                        }).emulateTransitionEnd(g)
                    } else t(s).removeClass(R), t(u).addClass(R), this._isSliding = !1, t(this._element).trigger(h);
                    f && this.cycle()
                }
            }, e._jQueryInterface = function (n) {
                return this.each(function () {
    ...
    t(document).on(W, q.DATA_SLIDE, F._dataApiClickHandler), t(window).on(H, function () {
        for (var e = [].slice.call(document.querySelectorAll(q.DATA_RIDE)), n = 0, i = e.length; n < i; n++) {
            var r = t(e[n]);
            F._jQueryInterface.call(r, r.data())
        }
    }), t.fn[_] = F._jQueryInterface, t.fn[_].Constructor = F, t.fn[_].noConflict = function () {
        return t.fn[_] = x, F._jQueryInterface
    };
    var V = "collapse",
        X = t.fn[V],
        Y = {
        ...
        Q = "shown.bs.collapse",
        G = "hide.bs.collapse",
        K = "hidden.bs.collapse",
        Z = "click.bs.collapse.data-api",
        J = "show",
        ee = "collapse",
        te = "collapsing",
        ne = "collapsed",
        ...
        re = function () {
            function e(e, t) {
                ...
                for (var n = [].slice.call(document.querySelectorAll(ie.DATA_TOGGLE)), i = 0, r = n.length; i < r; i++) {
                    var o = n[i],
            ...
            return n.toggle = function () {
                ...
                var n, i, r = this;
                if (!(this._isTransitioning || t(this._element).hasClass(J) || (this._parent && 0 === (n = [].slice.call(this._parent.querySelectorAll(ie.ACTIVES)).filter(function (e) {
                    ...
                    if (t(this._element).trigger(o), !o.isDefaultPrevented()) {
                        ...
                        t(this._element).one(l.TRANSITION_END, function () {
                            t(r._element).removeClass(te).addClass(ee).addClass(J), r._element.style[a] = "", r.setTransitioning(!1), t(r._element).trigger(Q)
                ...
                if (!this._isTransitioning && t(this._element).hasClass(J)) {
                    ...
                    if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                        ...
                        this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", l.reflow(this._element), t(this._element).addClass(te).removeClass(ee).removeClass(J);
                        var r = this._triggerArray.length;
                        if (r > 0)
                            for (var o = 0; o < r; o++) {
                                var a = this._triggerArray[o],
                                    s = l.getSelectorFromElement(a);
                                null !== s && (t([].slice.call(document.querySelectorAll(s))).hasClass(J) || t(a).addClass(ne).attr("aria-expanded", !1))
                            }
                        this.setTransitioning(!0), this._element.style[i] = "";
                        var c = l.getTransitionDurationFromElement(this._element);
                        t(this._element).one(l.TRANSITION_END, function () {
                            e.setTransitioning(!1), t(e._element).removeClass(te).addClass(ee).trigger(K)
                ...
                return (e = a({}, Y, e)).toggle = Boolean(e.toggle), l.typeCheckConfig(V, e, z), e
                ...
                return this.each(function () {
                    var i = t(this),
                        ...
                        o = a({}, Y, i.data(), "object" == typeof n && n ? n : {});
    ...
    t(document).on(Z, ie.DATA_TOGGLE, function (e) {
        ...
        t(r).each(function () {
            ...
            re._jQueryInterface.call(e, i)
        })
    }), t.fn[V] = re._jQueryInterface, t.fn[V].Constructor = re, t.fn[V].noConflict = function () {
        return t.fn[V] = X, re._jQueryInterface
    };
    var oe = "dropdown",
        ae = t.fn[oe],
        se = new RegExp("38|40|27"),
        le = "hide.bs.dropdown",
        ce = "hidden.bs.dropdown",
        ue = "show.bs.dropdown",
        de = "shown.bs.dropdown",
        fe = "click.bs.dropdown",
        he = "click.bs.dropdown.data-api",
        pe = "keydown.bs.dropdown.data-api",
        ge = "keyup.bs.dropdown.data-api",
        me = "disabled",
        ve = "show",
        ...
        Te = function () {
            ...
            return i.toggle = function () {
                if (!this._element.disabled && !t(this._element).hasClass(me)) {
                    var i = e._getParentFromElement(this._element),
                        r = t(this._menu).hasClass(ve);
                    if (e._clearMenus(), !r) {
                        var o = {
                        ...
                        if (t(i).trigger(a), !a.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var s = this._element;
                                "parent" === this._config.reference ? s = i : l.isElement(this._config.reference) && (s = this._config.reference, void 0 !== this._config.reference.jquery && (s = this._config.reference[0])), "scrollParent" !== this._config.boundary && t(i).addClass("position-static"), this._popper = new n(s, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === t(i).closest(".navbar-nav").length && t(document.body).children().on("mouseover", null, t.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), t(this._menu).toggleClass(ve), t(i).toggleClass(ve).trigger(t.Event(de, o))
                        }
                    }
                }
            }, i.show = function () {
                if (!(this._element.disabled || t(this._element).hasClass(me) || t(this._menu).hasClass(ve))) {
                    var n = {
                            relatedTarget: this._element
                        },
                        i = t.Event(ue, n),
                        r = e._getParentFromElement(this._element);
                    t(r).trigger(i), i.isDefaultPrevented() || (t(this._menu).toggleClass(ve), t(r).toggleClass(ve).trigger(t.Event(de, n)))
                }
            }, i.hide = function () {
                if (!this._element.disabled && !t(this._element).hasClass(me) && t(this._menu).hasClass(ve)) {
                    var n = {
                        ...
                        i = t.Event(le, n),
                        r = e._getParentFromElement(this._element);
                    t(r).trigger(i), i.isDefaultPrevented() || (t(this._menu).toggleClass(ve), t(r).toggleClass(ve).trigger(t.Event(ce, n)))
                }
            }, i.dispose = function () {
                ...
                var e = this;
                t(this._element).on(fe, function (t) {
                    t.preventDefault(), t.stopPropagation(), e.toggle()
                })
            }, i._getConfig = function (e) {
                return e = a({}, this.constructor.Default, t(this._element).data(), e), l.typeCheckConfig(oe, e, this.constructor.DefaultType), e
                ...
                var e = t(this._element.parentNode),
                    n = "bottom-start";
                return e.hasClass("dropup") ? (n = "top-start", t(this._menu).hasClass(ye) && (n = "top-end")) : e.hasClass("dropright") ? n = "right-start" : e.hasClass("dropleft") ? n = "left-start" : t(this._menu).hasClass(ye) && (n = "bottom-end"), n
                    ...
                    for (var i = [].slice.call(document.querySelectorAll(be)), r = 0, o = i.length; r < o; r++) {
                        ...
                        if (n && "click" === n.type && (l.clickEvent = n), s) {
                            ...
                            if (t(a).hasClass(ve) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "keyup" === n.type && 9 === n.which) && t.contains(a, n.target))) {
                                var u = t.Event(le, l);
                                t(a).trigger(u), u.isDefaultPrevented() || ("ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), i[r].setAttribute("aria-expanded", "false"), t(c).removeClass(ve), t(a).removeClass(ve).trigger(t.Event(ce, l)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || t(n.target).closest(we).length)) : se.test(n.which)) && (n.preventDefault(), n.stopPropagation(), !this.disabled && !t(this).hasClass(me))) {
    ...
    t(document).on(pe, be, Te._dataApiKeydownHandler).on(pe, we, Te._dataApiKeydownHandler).on(he + " " + ge, Te._clearMenus).on(he, be, function (e) {
        e.preventDefault(), e.stopPropagation(), Te._jQueryInterface.call(t(this), "toggle")
    }).on(he, ".dropdown form", function (e) {
        e.stopPropagation()
    }), t.fn[oe] = Te._jQueryInterface, t.fn[oe].Constructor = Te, t.fn[oe].noConflict = function () {
        return t.fn[oe] = ae, Te._jQueryInterface
    };
    var Ce = t.fn.modal,
        Se = {
            backdrop: !0,
        ...
        Ie = "keydown.dismiss.bs.modal",
        je = "mouseup.dismiss.bs.modal",
        $e = "mousedown.dismiss.bs.modal",
        Me = "click.bs.modal.data-api",
        He = "modal-open",
        We = "fade",
        Re = "show",
        qe = {
        ...
        Be = function () {
            ...
            return n.toggle = function (e) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    t(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(Le, qe.DATA_DISMISS, function (e) {
                        return n.hide(e)
                    }), t(this._dialog).on($e, function () {
                        t(n._element).one(je, function (e) {
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (t(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        ...
                        if (r && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off(De), t(this._element).removeClass(Re), t(this._element).off(Le), t(this._dialog).off($e), r) {
                ...
                }), t(document).off(De), t.removeData(this._element, "bs.modal"), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, n.handleUpdate = function () {
                this._adjustDialog()
            }, n._getConfig = function (e) {
                return e = a({}, Se, e), l.typeCheckConfig("modal", e, ke), e
            }, n._showElement = function (e) {
                var n = this,
                    i = t(this._element).hasClass(We);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), t(this._dialog).hasClass("modal-dialog-scrollable") ? this._dialog.querySelector(qe.MODAL_BODY).scrollTop = 0 : this._element.scrollTop = 0, i && l.reflow(this._element), t(this._element).addClass(Re), this._config.focus && this._enforceFocus();
                var r = t.Event(Ae, {
                        relatedTarget: e
                    }),
                    o = function () {
                ...
                var e = this;
                t(document).off(De).on(De, function (n) {
                    document !== n.target && e._element !== n.target && 0 === t(e._element).has(n.target).length && e._element.focus()
                })
            }, n._setEscapeEvent = function () {
                var e = this;
                this._isShown && this._config.keyboard ? t(this._element).on(Ie, function (t) {
                    27 === t.which && (t.preventDefault(), e.hide())
                }) : this._isShown || t(this._element).off(Ie)
            }, n._setResizeEvent = function () {
                var e = this;
                this._isShown ? t(window).on(Ne, function (t) {
                    return e.handleUpdate(t)
                }) : t(window).off(Ne)
            }, n._hideModal = function () {
                var e = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function () {
                    t(document.body).removeClass(He), e._resetAdjustments(), e._resetScrollbar(), t(e._element).trigger(Oe)
                })
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), t(this._backdrop).appendTo(document.body), t(this._element).on(Le, function (e) {
                            n._ignoreBackdropClick ? n._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === n._config.backdrop ? n._element.focus() : n.hide())
                        }), i && l.reflow(this._backdrop), t(this._backdrop).addClass(Re), !e) return;
                    if (!i) return void e();
                ...
                return this.each(function () {
                    var r = t(this).data("bs.modal"),
                        o = a({}, Se, t(this).data(), "object" == typeof n && n ? n : {});
    ...
    t(document).on(Me, qe.DATA_TOGGLE, function (e) {
        var n, i = this,
            r = l.getSelectorFromElement(this);
        r && (n = document.querySelector(r));
        var o = t(n).data("bs.modal") ? "toggle" : a({}, t(n).data(), t(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
        var s = t(n).one(Pe, function (e) {
            e.isDefaultPrevented() || s.one(Oe, function () {
        ...
        return t.fn.modal = Ce, Be._jQueryInterface
    };
        ...
        for (var i = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(t), o = [].slice.call(i.body.querySelectorAll("*")), a = function (e, n) {
                ...
                s.forEach(function (e) {
                    (function (e, t) {
                        ...
                        if (-1 !== t.indexOf(n)) return -1 === Fe.indexOf(n) || Boolean(e.nodeValue.match(Ve) || e.nodeValue.match(Xe));
            ...
            return i.enable = function () {
                ...
                if (this._isEnabled)
                    if (e) {
                        ...
                        if (t(this.getTipElement()).hasClass(it)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    a.setAttribute("id", s), this.element.setAttribute("aria-describedby", s), this.setContent(), this.config.animation && t(a).addClass(nt);
                    ...
                    }), t(a).addClass(it), "ontouchstart" in document.documentElement && t(document.body).children().on("mouseover", null, t.noop);
                    var f = function () {
                        e.config.animation && e._fixTransition();
                        var n = e._hoverState;
                        e._hoverState = null, t(e.element).trigger(e.constructor.Event.SHOWN), "out" === n && e._leave(null, e)
                    };
                    if (t(this.tip).hasClass(nt)) {
                ...
                var n = this,
                    ...
                    o = function () {
                        n._hoverState !== et && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), t(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), e && e()
                    };
                if (t(this.element).trigger(r), !r.isDefaultPrevented()) {
                    if (t(i).removeClass(it), "ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), this._activeTrigger.click = !1, this._activeTrigger[ot] = !1, this._activeTrigger[rt] = !1, t(this.tip).hasClass(nt)) {
                ...
                this.setElementContent(t(e.querySelectorAll(".tooltip-inner")), this.getTitle()), t(e).removeClass(nt + " " + it)
                ...
                this.config.trigger.split(" ").forEach(function (n) {
                    if ("click" === n) t(e.element).on(e.constructor.Event.CLICK, e.config.selector, function (t) {
                        ...
                        var i = n === rt ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
                            r = n === rt ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                ...
                (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)), e && (n._activeTrigger["focusin" === e.type ? ot : rt] = !0), t(n.getTipElement()).hasClass(it) || n._hoverState === et ? n._hoverState = et : (clearTimeout(n._timeout), n._hoverState = et, n.config.delay && n.config.delay.show ? n._timeout = setTimeout(function () {
                    n._hoverState === et && n.show()
                }, n.config.delay.show) : n.show())
            }, i._leave = function (e, n) {
                var i = this.constructor.DATA_KEY;
                (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)), e && (n._activeTrigger["focusout" === e.type ? ot : rt] = !1), n._isWithActiveTrigger() || (clearTimeout(n._timeout), n._hoverState = "out", n.config.delay && n.config.delay.hide ? n._timeout = setTimeout(function () {
                ...
                return Object.keys(n).forEach(function (e) {
                    -1 !== Ge.indexOf(e) && delete n[e]
                }), "number" == typeof (e = a({}, this.constructor.Default, n, "object" == typeof e && e ? e : {})).delay && (e.delay = {
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), l.typeCheckConfig(ze, e, this.constructor.DefaultType), e.sanitize && (e.template = Ye(e.template, e.whiteList, e.sanitizeFn)), e
                ...
                null === e.getAttribute("x-placement") && (t(e).removeClass(nt), this.config.animation = !1, this.hide(), this.show(), this.config.animation = n)
            }, e._jQueryInterface = function (n) {
                return this.each(function () {
    ...
    t.fn.tooltip = at._jQueryInterface, t.fn.tooltip.Constructor = at, t.fn.tooltip.noConflict = function () {
        return t.fn.tooltip = Ue, at._jQueryInterface
    };
    var st = t.fn.popover,
    ...
    t.fn.popover = ft._jQueryInterface, t.fn.popover.Constructor = ft, t.fn.popover.noConflict = function () {
        return t.fn.popover = st, ft._jQueryInterface
    };
    var ht = "scrollspy",
        pt = t.fn[ht],
        gt = {
        ...
        _t = function () {
            function e(e, n) {
                var i = this;
                this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(n), this._selector = this._config.target + " " + bt.NAV_LINKS + "," + this._config.target + " " + bt.LIST_ITEMS + "," + this._config.target + " " + bt.DROPDOWN_ITEMS, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, t(this._scrollElement).on(vt.SCROLL, function (e) {
                    return i._process(e)
            ...
            return n.refresh = function () {
                var e = this,
                    n = this._scrollElement === this._scrollElement.window ? "offset" : wt,
                    i = "auto" === this._config.method ? n : this._config.method,
                    r = i === wt ? this._getScrollTop() : 0;
                ...
                if ("string" != typeof (e = a({}, gt, "object" == typeof e && e ? e : {})).target) {
                    var n = t(e.target).attr("id");
                    n || (n = l.getUID(ht), t(e.target).attr("id", n)), e.target = "#" + n
                }
                return l.typeCheckConfig(ht, e, mt), e
                ...
                i.hasClass("dropdown-item") ? (i.closest(bt.DROPDOWN).find(bt.DROPDOWN_TOGGLE).addClass(yt), i.addClass(yt)) : (i.addClass(yt), i.parents(bt.NAV_LIST_GROUP).prev(bt.NAV_LINKS + ", " + bt.LIST_ITEMS).addClass(yt), i.parents(bt.NAV_LIST_GROUP).prev(bt.NAV_ITEMS).children(bt.NAV_LINKS).addClass(yt)), t(this._scrollElement).trigger(vt.ACTIVATE, {
                    relatedTarget: e
                })
            }, n._clear = function () {
    ...
    t(window).on(vt.LOAD_DATA_API, function () {
        for (var e = [].slice.call(document.querySelectorAll(bt.DATA_SPY)), n = e.length; n--;) {
            var i = t(e[n]);
            _t._jQueryInterface.call(i, i.data())
        }
    }), t.fn[ht] = _t._jQueryInterface, t.fn[ht].Constructor = _t, t.fn[ht].noConflict = function () {
        return t.fn[ht] = pt, _t._jQueryInterface
    };
    var xt = t.fn.tab,
        Tt = "hide.bs.tab",
        Ct = "hidden.bs.tab",
        ...
        Dt = function () {
            ...
            return n.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(Ot) || t(this._element).hasClass("disabled"))) {
                    ...
                    if (r) {
                        var a = "UL" === r.nodeName || "OL" === r.nodeName ? At : Pt;
                ...
                var r = this,
                    o = (!n || "UL" !== n.nodeName && "OL" !== n.nodeName ? t(n).children(Pt) : t(n).find(At))[0],
                ...
                if (t(e).addClass(Ot), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), l.reflow(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && t(e.parentNode).hasClass("dropdown-menu")) {
    ...
    t(document).on(Et, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (e) {
        e.preventDefault(), Dt._jQueryInterface.call(t(this), "show")
    }), t.fn.tab = Dt._jQueryInterface, t.fn.tab.Constructor = Dt, t.fn.tab.noConflict = function () {
        return t.fn.tab = xt, Dt._jQueryInterface
    };
    var Nt = t.fn.toast,
        ...
        Bt = function () {
            ...
            return n.show = function () {
                var e = this;
                t(this._element).trigger($t), this._config.animation && this._element.classList.add("fade");
                var n = function () {
                    e._element.classList.remove(Wt), e._element.classList.add(Ht), t(e._element).trigger(Mt), e._config.autohide && e.hide()
                };
                if (this._element.classList.remove("hide"), this._element.classList.add(Wt), this._config.animation) {
                    var i = l.getTransitionDurationFromElement(this._element);
                    t(this._element).one(l.TRANSITION_END, n).emulateTransitionEnd(i)
                } else n()
            }, n.hide = function (e) {
                var n = this;
                this._element.classList.contains(Ht) && (t(this._element).trigger(It), e ? this._close() : this._timeout = setTimeout(function () {
                    n._close()
                }, this._config.delay))
            }, n.dispose = function () {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Ht) && this._element.classList.remove(Ht), t(this._element).off(Lt), t.removeData(this._element, "bs.toast"), this._element = null, this._config = null
            }, n._getConfig = function (e) {
                return e = a({}, qt, t(this._element).data(), "object" == typeof e && e ? e : {}), l.typeCheckConfig("toast", e, this.constructor.DefaultType), e
            }, n._setListeners = function () {
                var e = this;
                t(this._element).on(Lt, '[data-dismiss="toast"]', function () {
                    return e.hide(!0)
                })
            }, n._close = function () {
                var e = this,
                    n = function () {
                        e._element.classList.add("hide"), t(e._element).trigger(jt)
                    };
                if (this._element.classList.remove(Ht), this._config.animation) {
                    var i = l.getTransitionDurationFromElement(this._element);
                    t(this._element).one(l.TRANSITION_END, n).emulateTransitionEnd(i)
                } else n()
            }, e._jQueryInterface = function (n) {
    ...
    t.fn.toast = Bt._jQueryInterface, t.fn.toast.Constructor = Bt, t.fn.toast.noConflict = function () {
            return t.fn.toast = Nt, Bt._jQueryInterface
        },
        function () {
            if (void 0 === t) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
            var e = t.fn.jquery.split(" ")[0].split(".");
            if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || e[0] >= 4) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }(), e.Util = l, e.Alert = h, e.Button = w, e.Carousel = F, e.Collapse = re, e.Dropdown = Te, e.Modal = Be, e.Popover = ft, e.Scrollspy = _t, e.Tab = Dt, e.Toast = Bt, e.Tooltip = at, Object.defineProperty(e, "__esModule", {
            value: !0
        })
        ...
        return function (e, t, n, i) {
            ...
            function a(e, n, i, r) {
                ...
                var v = g ? new Float32Array(h) : new Array(h),
                    y = !1,
                    b = function (t) {
                        return y || (y = !0, (e != n || i != r) && function () {
                            for (var t = 0; h > t; ++t) v[t] = l(t * p, e, i)
                        }()), e === n && i === r ? t : 0 === t ? 0 : 1 === t ? 1 : l(function (t) {
                            for (var n = 0, r = 1, o = h - 1; r != o && v[r] <= t; ++r) n += p;
                            var a = n + (t - v[--r]) / (v[r + 1] - v[r]) * p,
                                s = c(a, e, i);
                            return s >= .001 ? function (t, n) {
                                for (var r = 0; u > r; ++r) {
                                    var o = c(n, e, i);
                                    if (0 === o) return n;
                                    n -= (l(n, e, i) - t) / o
                                ...
                                return n
                            }(t, a) : 0 == s ? a : function (t, n, r) {
                                var o, a, s = 0;
                                do {
                                    (o = l(a = n + (r - n) / 2, e, i) - t) > 0 ? r = a : n = a
                                } while (Math.abs(o) > d && ++s < f);
                                return a
                            }(t, n, n + p)
                        }(t), n, r)
                    };
                    ...
                    for (var r = 0; n > r; r++)
                        if (v.State.calls[r]) {
                            ...
                            for (var m = Math.min((t - f) / d.duration, 1), y = 0, w = s.length; w > y; y++) {
                                ...
                                if (o(T)) {
                                    var C = !1;
                                    for (var S in d.display !== i && null !== d.display && "none" !== d.display && ("flex" === d.display && u.each(["-webkit-box", "-moz-box", "-ms-flexbox", "-webkit-flex"], function (e, t) {
                                            b.setPropertyValue(T, "display", t)
                                        }), b.setPropertyValue(T, "display", d.display)), d.visibility !== i && "hidden" !== d.visibility && b.setPropertyValue(T, "visibility", d.visibility), x)
                                        if ("element" !== S) {
                                            var k, E = x[S],
                                                O = h.isString(E.easing) ? v.Easings[E.easing] : E.easing;
                                            if (1 === m) k = E.endValue;
                                            else {
                                                var P = E.endValue - E.startValue;
                                                if (k = E.startValue + P * O(m, d, P), !p && k === E.currentValue) continue
                                            }
                                            if (E.currentValue = k, "tween" === S) g = k;
                                            else {
                                                if (b.Hooks.registered[S]) {
                                                    var A = b.Hooks.getRoot(S),
                                                        D = o(T).rootPropertyValueCache[A];
                                                    D && (E.rootPropertyValue = D)
                                                }
                                                var N = b.setPropertyValue(T, S, E.currentValue + (0 === parseFloat(k) ? "" : E.unitType), E.rootPropertyValue, E.scrollData);
                                                b.Hooks.registered[S] && (o(T).rootPropertyValueCache[A] = b.Normalizations.registered[A] ? b.Normalizations.registered[A]("extract", null, N[1]) : N[1]), "transform" === N[0] && (C = !0)
                                            }
                                        } d.mobileHA && o(T).transformCache.translate3d === i && (o(T).transformCache.translate3d = "(0px, 0px, 0px)", C = !0), C && b.flushTransformCache(T)
                                }
                            }
                ...
                var w = function () {
                        ...
                        function e(e) {
                            function f(e, t) {
                                var n = i,
                                    r = i,
                                    o = i;
                                return h.isArray(e) ? (n = e[0], !h.isArray(e[1]) && /^[\d-]/.test(e[1]) || h.isFunction(e[1]) || b.RegEx.isHex.test(e[1]) ? o = e[1] : (h.isString(e[1]) && !b.RegEx.isHex.test(e[1]) || h.isArray(e[1])) && (r = t ? e[1] : s(e[1], c.duration), e[2] !== i && (o = e[2]))) : n = e, t || (r = r || c.easing), h.isFunction(n) && (n = n.call(a, C, T)), h.isFunction(o) && (o = o.call(a, C, T)), [n || 0, r, o]
                            }
                            ...
                            function g() {
                                ...
                                if (r && i) l.emToPx = I.lastEmToPx, l.percentToPxWidth = I.lastPercentToPxWidth, l.percentToPxHeight = I.lastPercentToPxHeight;
                                    ...
                                    }), v.CSS.setPropertyValue(c, "paddingLeft", s + "em"), l.percentToPxWidth = I.lastPercentToPxWidth = (parseFloat(b.getPropertyValue(c, "width", null, !0)) || 1) / s, l.percentToPxHeight = I.lastPercentToPxHeight = (parseFloat(b.getPropertyValue(c, "height", null, !0)) || 1) / s, l.emToPx = I.lastEmToPx = (parseFloat(b.getPropertyValue(c, "paddingLeft")) || 1) / s, e.myParent.removeChild(c)
                                }
                                return null === I.remToPx && (I.remToPx = parseFloat(b.getPropertyValue(n.body, "fontSize")) || 16), null === I.vwToPx && (I.vwToPx = parseFloat(t.innerWidth) / 100, I.vhToPx = parseFloat(t.innerHeight) / 100), l.remToPx = I.remToPx, l.vwToPx = I.vwToPx, l.vhToPx = I.vhToPx, v.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), a), l
                            }
                            if (c.begin && 0 === C) try {
                                c.begin.call(m, m)
                            } catch (e) {
                            ...
                            if ("scroll" === k) {
                                var w, x, S, O = /^x$/i.test(c.axis) ? "Left" : "Top",
                                    P = parseFloat(c.offset) || 0;
                                c.container ? h.isWrapped(c.container) || h.isNode(c.container) ? (c.container = c.container[0] || c.container, S = (w = c.container["scroll" + O]) + u(a).position()[O.toLowerCase()] + P) : c.container = null : (w = v.State.scrollAnchor[v.State["scrollProperty" + O]], x = v.State.scrollAnchor[v.State["scrollProperty" + ("Left" === O ? "Top" : "Left")]], S = u(a).offset()[O.toLowerCase()] + P), d = {
                                    scroll: {
                                        rootPropertyValue: !1,
                                        startValue: w,
                                        currentValue: w,
                                ...
                                var A = u.extend(!0, {}, o(a).tweensContainer);
                                for (var D in A)
                                    if ("element" !== D) {
                                        var N = A[D].startValue;
                                        A[D].startValue = A[D].currentValue = A[D].endValue, A[D].endValue = N, h.isEmptyObject(_) || (A[D].easing = c.easing), v.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(A[D]), a)
                                    } d = A
                            } else if ("start" === k) {
                                for (var L in o(a).tweensContainer && !0 === o(a).isAnimating && (A = o(a).tweensContainer), u.each(y, function (e, t) {
                                    ...
                                    if (o(a).isSVG || "tween" === R || !1 !== b.Names.prefixCheck(R)[1] || b.Normalizations.registered[R] !== i) {
                                        ...
                                        var B, F, V, X = !1;
                                        if (W = (B = p(L, W))[0], V = B[1], M = (B = p(L, M))[0].replace(/^([+-\/*])=/, function (e, t) {
                                                return X = t, ""
                                            }), F = B[1], W = parseFloat(W) || 0, M = parseFloat(M) || 0, "%" === F && (/^(fontSize|lineHeight)$/.test(L) ? (M /= 100, F = "em") : /^scale/.test(L) ? (M /= 100, F = "") : /(Red|Green|Blue)$/i.test(L) && (M = M / 100 * 255, F = "")), /[\/*]/.test(X)) F = V;
                                        else if (V !== F && 0 !== W)
                                            if (0 === M) F = V;
                                            else {
                                                r = r || g();
                            ...
                            d.element && (b.Values.addClass(a, "velocity-animating"), j.push(d), "" === c.queue && (o(a).tweensContainer = d, o(a).opts = c), o(a).isAnimating = !0, C === T - 1 ? (v.State.calls.push([j, m, c, null, E.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l())) : C++)
                        }
                        var r, a = this,
                    ...
                    if (h.isWrapped(this) ? (d = !1, p = 0, m = this, f = this) : (d = !0, p = 1, m = x ? arguments[0].elements || arguments[0].e : arguments[0]), m = r(m)) {
                        ...
                        if (!/^(stop|finish)$/i.test(y) && !u.isPlainObject(_)) {
                            _ = {};
                            for (var S = p + 1; S < arguments.length; S++) h.isArray(arguments[S]) || !/^(fast|normal|slow)$/i.test(arguments[S]) && !/^\d/.test(arguments[S]) ? h.isString(arguments[S]) || h.isArray(arguments[S]) ? _.easing = arguments[S] : h.isFunction(arguments[S]) && (_.complete = arguments[S]) : _.duration = arguments[S]
                        }
                        var k, E = {
                            promise: null,
                            resolver: null,
                            ...
                            default:
                                if (!u.isPlainObject(y) || h.isEmptyObject(y)) {
                                    if (h.isString(y) && v.Redirects[y]) {
                                        var P = (L = u.extend({}, _)).duration,
                                            A = L.delay || 0;
                                        return !0 === L.backwards && (m = u.extend(!0, [], m).reverse()), u.each(m, function (e, t) {
                                            parseFloat(L.stagger) ? L.delay = A + parseFloat(L.stagger) * e : h.isFunction(L.stagger) && (L.delay = A + L.stagger.call(t, e, T)), L.drag && (L.duration = parseFloat(P) || (/^(callout|transition)/.test(y) ? 1e3 : g), L.duration = Math.max(L.duration * (L.backwards ? 1 - e / T : (e + 1) / T), .75 * L.duration, 200)), v.Redirects[y].call(t, t, L || {}, e, T, m, E.promise ? E : i)
                                        }), e()
                                    }
                        ...
                        if (u.each(m, function (e, t) {
                                h.isNode(t) && a.call(t)
                            }), (L = u.extend({}, v.defaults, _)).loop = parseInt(L.loop), N = 2 * L.loop - 1, L.loop)
                            for (var $ = 0; N > $; $++) {
                                var M = {
                                    delay: L.delay,
                                    progress: L.progress
                                };
                                $ === N - 1 && (M.display = L.display, M.visibility = L.visibility, M.complete = L.complete), w(m, "reverse", M)
                            }
                        return e()
                    }
                };
                        ...
                        e(".wow").each(function () {
                            if ("visible" != e(this).css("visibility") && (n + i - 100 > r(this) && i < r(this) || n + i - 100 > r(this) + e(this).height() && i < r(this) + e(this).height() || n + i == e(document).height() && r(this) + 100 > e(document).height())) {
                                ...
                                if (a) {
                                    ...
                                    var s = this;
                                    parseFloat(a), e(s).addClass("animated"), e(s).css({
                                        visibility: "visible"
                                    }), e(s).css({
                                        "animation-delay": a
                                    }), e(s).css({
                                    ...
                                    e(this).attr("data-wow-delay") && (l += 1e3 * e(this).attr("data-wow-delay").slice(0, -1)), s = this, setTimeout(function () {
                                        e(s).removeClass("animated")
                                    }, l)
                                } else e(this).addClass("animated"), e(this).css({
                                    visibility: "visible"
                                }), e(this).css({
                                    "animation-name": t[o]
                                }), l = 1e3 * e(this).css("animation-duration").slice(0, -1), s = this, setTimeout(function () {
                                    e(s).removeClass("animated")
                                }, l)
                            }
                        })
        ...
        return e.init = function (e) {
            ...
            if ((t = t || {}).wait = t.wait || 0, t.position = t.position || null, n)
                for (var i, r, s, c = {}, u = 0, d = {
                    ...
                    }; u < n; u++) i = e[u], r = t.position || {
                    x: i.clientWidth / 2,
                    y: i.clientHeight / 2
                }, s = a(i), c.x = s.left + r.x, c.y = s.top + r.y, d.pageX = c.x, d.pageY = c.y, l.show(d, i), t.wait >= 0 && null !== t.wait && setTimeout(f({
                    type: "mouseup",
                    button: 1
                }, i), t.wait)
        }, e.calm = function (e) {
...
function (e) {
    ...
    }(jQuery), ("function" == typeof define && define.amd ? define : function (e, t) {
        ...
        return function () {
            var t, n, i, r = 0,
                ...
                c = {
                    ...
                    remove: function (n) {
                        var i = p();
                        t || u(i), n && 0 === e(":focus", n).length ? g(n) : t.children().length && t.remove()
                    },
            ...
            function u(n, i) {
                return n || (n = p()), (t = e("#" + n.containerId)).length ? t : (i && (t = function (n) {
            ...
            function h(n) {
                ...
                if (void 0 !== n.optionsOverride && (o = e.extend(o, n.optionsOverride), a = n.optionsOverride.iconClass || a), ! function (e, t) {
                    ...
                    return n.iconClass && l.addClass(o.toastClass).addClass(a), n.title && (c.append(n.title).addClass(o.titleClass), l.append(c)), n.message && (d.append(n.message).addClass(o.messageClass), l.append(d)), o.closeButton && (m.addClass("md-toast-close-button").attr("role", "button"), l.prepend(m)), o.progressBar && (h.addClass("md-toast-progress"), l.prepend(h)), o.newestOnTop ? t.prepend(l) : t.append(l), l.hide(), l[o.showMethod]({
                        duration: o.showDuration,
                        easing: o.showEasing,
                        complete: o.onShown
                    }), o.timeOut > 0 && (s = setTimeout(b, o.timeOut), v.maxHideTime = parseFloat(o.timeOut), v.hideEta = (new Date).getTime() + v.maxHideTime, o.progressBar && (v.intervalId = setInterval(function () {
                        var e = (v.hideEta - (new Date).getTime()) / v.maxHideTime * 100;
                        h.width(e + "%")
                    }, 10))), l.hover(_, w), !o.onclick && o.tapToDismiss && l.click(b), o.closeButton && m && m.click(function (e) {
                        ...
                        o.onclick(), b()
                    }), f(y), o.debug && console && console.log(y), l
                }

                function b(t) {
                    if (!e(":focus", l).length || t) return clearTimeout(v.intervalId), l[o.hideMethod]({
                        duration: o.hideDuration,
                        easing: o.hideEasing,
                        complete: function () {
                            g(l), o.onHidden && "hidden" !== y.state && o.onHidden(), y.state = "hidden", y.endTime = new Date, f(y)
                        }
                    })
                }

                function w() {
                    (o.timeOut > 0 || o.extendedTimeOut > 0) && (s = setTimeout(b, o.extendedTimeOut), v.maxHideTime = parseFloat(o.extendedTimeOut), v.hideEta = (new Date).getTime() + v.maxHideTime)
                }

                function _() {
                    clearTimeout(s), v.hideEta = 0, l.stop(!0, !0)[o.showMethod]({
                        duration: o.showDuration,
                        easing: o.showEasing
                    })
                }
        ...
        e.fn.scrollTo = function (t) {
            ...
            this.each(function () {
                ...
                function s(t) {
                    ...
                    "left" === d ? (f = i.gutter, h = n.position().left + f) : "right" === d && (h = n.position().left + n.outerWidth() - o.outerWidth() + (f = -i.gutter)), o.css({
                        position: "absolute",
...
dropdownSelectors.on({
    ...
    function (e) {
        ...
        e(".fixed-action-btn:not(.smooth-scroll) > .btn-floating").on("click", function (r) {
            if (!e(t).hasClass("smooth-scroll")) return r.preventDefault(), (o = e(".fixed-action-btn")).hasClass("active") ? i(o) : n(o), !1;
            var o
        })
    }(jQuery),
    function (e) {
        ...
        e.fn.collapsible = function (t) {
            ...
            return t = e.extend({
                ...
                a.off("click.collapse", ".collapsible-header"), s.off("click.collapse"), t.accordion || "accordion" === l || void 0 === l ? ((s = a.find("> li > .collapsible-header")).on("click.collapse", function (t) {
                    var i = e(t.target);
                    r(i) && (i = o(i)), i.toggleClass("active"), n(a, i)
                }), n(a, s.filter(".active").first())) : s.each(function () {
            ...
            t.exports = function (e) {
                ! function (e, t) {
                    ...
                    t.event.bind(e, "mouseenter", function () {
                        ...
                        if (!(o.isDefaultPrevented && o.isDefaultPrevented() || o.defaultPrevented)) {
                            var l = r.matches(t.scrollbarX, ":focus") || r.matches(t.scrollbarY, ":focus");
                            if (n || l) {
                                ...
                                switch (o.which) {
                                    case 37:
                                        u = o.metaKey ? -t.contentWidth : o.altKey ? -t.containerWidth : -30;
                                        break;
                                    case 38:
                                        d = o.metaKey ? t.contentHeight : o.altKey ? t.containerHeight : 30;
                                        break;
                                    case 39:
                                        u = o.metaKey ? t.contentWidth : o.altKey ? t.containerWidth : 30;
                                        break;
                                    ...
                                    case 34:
                                        ...
                                        break;
                                    case 35:
                                        d = o.ctrlKey ? -t.contentHeight : -t.containerHeight;
                                        break;
                                    case 36:
                                        d = o.ctrlKey ? e.scrollTop : t.containerHeight;
                                        break;
                                    default:
                                        return
                                }
                                s(e, "top", e.scrollTop - d), s(e, "left", e.scrollLeft + u), a(e),
                                    function (n, i) {
                                        var r = e.scrollTop;
                                        if (0 === n) {
                ...
                ! function (e, t) {
                    function n(n) {
                        ...
                        (function (t, n) {
                            ...
                            return !1
                        })(s, l) || (i = !1, t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (o(e, "top", l ? e.scrollTop - l * t.settings.wheelSpeed : e.scrollTop + s * t.settings.wheelSpeed), i = !0) : t.scrollbarXActive && !t.scrollbarYActive && (o(e, "left", s ? e.scrollLeft + s * t.settings.wheelSpeed : e.scrollLeft - l * t.settings.wheelSpeed), i = !0) : (o(e, "top", e.scrollTop - l * t.settings.wheelSpeed), o(e, "left", e.scrollLeft + s * t.settings.wheelSpeed)), r(e), (i = i || function (n, i) {
                            var r = e.scrollTop;
                            if (0 === n) {
                                if (!t.scrollbarYActive) return !1;
                                if (0 === r && i > 0 || r >= t.contentHeight - t.containerHeight && i < 0) return !t.settings.wheelPropagation
                ...
                ! function (e, t) {
                    function n() {
                        l || (l = setInterval(function () {
                            return r.get(e) ? (a(e, "top", e.scrollTop + c.top), a(e, "left", e.scrollLeft + c.left), void o(e)) : void clearInterval(l)
                        }, 50))
                    }
                    ...
                    t.event.bind(t.ownerDocument, "selectionchange", function () {
                        ...
                        if (u) {
                            ...
                            r.x < o.left + 3 ? (c.left = -5, i.startScrolling(e, "x")) : r.x > o.right - 3 ? (c.left = 5, i.startScrolling(e, "x")) : c.left = 0, r.y < o.top + 3 ? (c.top = o.top + 3 - r.y < 5 ? -5 : -20, i.startScrolling(e, "y")) : r.y > o.bottom - 3 ? (c.top = r.y - o.bottom + 3 < 5 ? 5 : 20, i.startScrolling(e, "y")) : c.top = 0, 0 === c.top && 0 === c.left ? s() : n()
                        }
                    })
                }(e, r.get(e))
            }
                    ...
                    clone: function (e, t) {
                        ...
                        switch (t = t || {}, i) {
                            case "Object":
                                ...
                                return r;
                            case "Array":
                                return t[n.util.objId(e)] ? t[n.util.objId(e)] : (r = [], t[n.util.objId(e)] = r, e.forEach(function (e, i) {
                                ...
                                for (var b = r, w = o; b < t.length; w += t[b].length, ++b) {
                                    ...
                                    if (!(_ instanceof l)) {
                                        if (g && b != t.length - 1) {
                                            ...
                                            for (var x = E.index + (p ? E[1].length : 0), T = E.index + E[0].length, C = b, S = w, k = t.length; C < k && (S < T || !t[C].type && !t[C - 1].greedy); ++C) x >= (S += t[C].length) && (++b, w = S);
                                            if (t[b] instanceof l) continue;
                                            O = C - b, _ = e.slice(w, S), E.index -= w
                                        } else {
                                            f.lastIndex = 0;
                                            var E = f.exec(_),
                                                O = 1
                                        ...
                                        if (E) {
                                            p && (m = E[1] ? E[1].length : 0), T = (x = E.index + m) + (E = E[0].slice(m)).length;
                                            var P = _.slice(0, x),
                                                A = _.slice(T),
                                                D = [b, O];
                                            P && (++b, w += P.length, D.push(P));
                                            var N = new l(c, h ? n.tokenize(E, h) : E, v, E, g);
                                            if (D.push(N), A && D.push(A), Array.prototype.splice.apply(t, D), 1 != O && n.matchGrammar(e, t, i, b, w, !0, c), a) break
                                        } else if (a) break
                                    }
                                }
                            }
